...
"font-size: 20px;\n"
"color: #fff;"));
        exportButton_2 = new QPushButton(centralwidget);
        exportButton_2->setObjectName("exportButton_2");
        exportButton_2->setGeometry(QRect(985, 170, 150, 45));
        sizePolicy.setHeightForWidth(exportButton_2->sizePolicy().hasHeightForWidth());
        exportButton_2->setSizePolicy(sizePolicy);
        exportButton_2->setCursor(QCursor(Qt::PointingHandCursor));
        exportButton_2->setStyleSheet(QString::fromUtf8("background-color: #017F36; \n"
"height: 120px;\n"
"font-weight:  bold;\n"
"font-family: Montserrat;\n"
"font-size: 20px;\n"
"color: #fff;"));
    ...
    void retranslateUi(QMainWindow *DogsList)
    {
        ...
        exportButton_2->setText(QCoreApplication::translate("DogsList", "+ Dodaj", nullptr));
    } // retranslateUi
